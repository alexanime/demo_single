    ...
    if DEMO_MODE:
        bot.send_message(
            ...
            (
                ...
                "как такой бот будет выглядеть у вашей студии или мастера: меню услуг, "
                "портфолио по подвидам, календарь записи и аккуратные подтверждения.\n\n"
                "Ничего настоящего тут не происходит: записи никуда не сохраняются, "
                "никто вам не позвонит и не приедет.\n\n"
